...
public class Projeto {
    ...
    public static void Pergunta2() {
        ...
        delay(message);
                ...
                System.out.println("Após a explosão do tanque de combustível do avião, você retorna até o mesmo e\n"
    ...
    public static void Pergunta2_1() {
        ...
        String message = "\n25/03/2020 10:13:01 \n";
        delay(message);
                System.out.println("Mesmo após a explosão você vasculha a cabine em busca de alimento ou kit médico, pois está ferido devido à queda do avião.\n"
                ...
                System.out.println("Então você rapidamente se retira do avião, pois dentro  dele ainda está uma temperatura altíssima devido ao incêndio causado pela explosão.\n"
    ...
    public static void Pergunta2_2() {
        ...
        String message = "25/03/2020 10:13:01\n";
                delay(message);
                System.out.println("Ao entrar no avião procurando por mantimentos você acaba não encontrando nada, mas ao chegar\n"
                ...
                System.out.println("Então você rapidamente se retira do avião, pois dentro dele ainda está uma temperatura altíssima \n"
    ...
    public static void Pergunta2_3() {
        ...
        String message = "25/03/2020 10:13:01\n";
        delay(message);
                System.out.println("Ao entrar no avião procurando seus pertences você descobre que grande parte deles está carbonizado,\n"
                ...
                + "sinalizador de emergência com apenas uma munição.\n");
                try{                 
                    TimeUnit.SECONDS.sleep(20);                 
                }                
                catch(InterruptedException e){                                      
                }
                System.out.println("Então você rapidamente se retira do avião, pois \n"
    ...
    public static void Pergunta1_2() {
        ...
        delay(message);
                ...
                System.out.println("Após alguns segundos você resolve olhar pela janela e percebe que o combustível\n"
    ...
    public static void Pergunta3_1() {
        String message = "\n25/03/2020 15:01:21\n";
                delay(message);
                System.out.println("Depois de seguir por um bom tempo você decide parar para descansar e procurar por comida e um abrigo,\n"
                ...
                System.out.println("Então você decide procurar por uma local para servir de abrigo perto do Rio, posteriormente você acaba encontrando uma\n"
                + "cavidade e passa a noite por ali.\n ");
                message = "\n26/03/2020 06:25:11\n";
                        delay(message);
                System.out.println("Ao acordar você percebe uma movimentação entranha ao seu redor, depois de se levantar calmamente você avista uma onça e ela te vê também.\n"
                + "O que você faz?\n"
    ...
    public static void Pergunta3_2() {
        String message = "\n25/03/2020 13:01:21\n";
                delay(message);
                System.out.println("Depois de ter esperado um tempo perto do avião, você decide procurar por algum alimento ao redor do\n"
    ...
    public static void Pergunta3_1_1() {
        ...
        System.out.println("\nDepois de limpar uma pequena área, você começa a fazer uma pequena estrutura com\n"
                ...
                System.out.println("mas acaba ignorando por ele ser minúsculo ao voltar para o seu abrigo você posiciona as folhas, depois disso você\n"
    ...
    public static void Pergunta4_1() {
        ...
        System.out.println("\nAo disparar o sinalizador em direção a onça você acaba conseguindo espanta-la, depois desse susto\n"
                ...
                + "estava alta e o barco um pouco longe. ");
                try{                 
                    TimeUnit.SECONDS.sleep(30);                 
                }                
                catch(InterruptedException e){                                      
                }
                System.out.println("\nSe você estivesse com o seu sinalizador provavelmente teria sido avistado, depois dessa\n"
                ...
                System.out.println("Despois de muito tempo caminhando você decide fazer uma pausa pois estava esgotado, posteriormente você acorda e.\n"
                + "O que você faz?\n"
    ...
    public static void Pergunta4_2() {
        ...
        System.out.println("Por sorte você encontra um galho para se defender e começa a intimidar a onça,\n"
                ...
                System.out.println("Depois de alguns segundos o barco começa a vir na sua direção, e ao chegar mais perto a música\n"
    ...
    public static void Pergunta5_2() {
        ...
        System.out.println("Você acaba acordando no meio da noite atordoado com uma grande chuva, e está tendo uma enchente\n"
                ...
                String message = "Após cair do barraco, você desmaiou e entrou no rio desacordado...Você morreu afogado!\n";
                delay(message);
    }
    ...
    public static void Pergunta1_3() {
        ...
        System.out.println("\n25/03/2020 08:15:32 \n"
                ...
                System.out.println("Você permanece tentando contato com a torre de controle\n"
    ...
    public static void Pergunta1_3_3() {
        String message = "\n25/03/2020 08:17:16\n";
                delay(message);
                System.out.println("Após sair do avião, o mesmo tem uma grande explosão, você não foi afetado\n"
    ...
    public static void Pergunta2_3_1() {
        System.out.println("Depois de sair do avião você continua tentando contato, mas depois de muita insistência a bateria\n"
                ...
                System.out.println("Posteriormente você volta ao avião para encontrar alguns fios para amarrar sua jangada, após pegar alguns fios você avista alguns outros, que estão um pouco mais presos.\n"
                + "Oque você faz?\n"
    ...
    public static void Pergunta2_3_2() {
        ...
        String message = "\n25/03/2020 08:42:11\n";
        delay(message);
        System.out.println("Você olha ao redor e tenta encontrar uma colina.\n"
                + "Ao olhar ao seu redor você avista diversas montanhas e decide ir para a mais próxima, no caminho para a montanha você\n"
                + "encontra um pé de Tucumã e acaba pegando algumas frutas e comendo ali no local, e depois pega um pouco mais e continua a sua jornada.\n"
    ...
    public static void Pergunta2_3_3() {
        String message = "\n25/03/2020 13:22:06\n";
        delay(message);
                System.out.println("Depois de passar muito tempo para conseguir tirar os fios você finalmente consegue, então decide pegar alguns bambus\n"
    ...
    public static void Pergunta2_3_3_1() {
        ...
        delay(message);
                System.out.println("Então você inicia sua viagem, após um tempo você acaba avistando uma corredeira e que você está\n"
                ...
                System.out.println("e a força da água acaba te empurrando para o fundo do rio, e você não tem forças para se salvar e...");
                message = "Você morreu afogado\n";
                delay(message);
        System.out.println(message);
    }
    ...
    public static void Pergunta2_3_3_3() {
        ...
        String message = "25/03/2020 13:22:06\n";
                delay(message);
                System.out.println("Então você pega alguns bambus com um pedaço de metal dos destroços do avião, posteriormente ao pegar uma quantidade\n"
                ...
                System.out.println("passa a noite lá, ao amanhecer você faz o preparo de tudo, coleta mais algumas frutas e improvisa um remo, então finalmente você começa a navegar.\n"
    ...
    public static void Pergunta2_3_3_3_2() {
        String message = "26/03/2020 15:31:27\n";
                ...
                System.out.println("Então você desesperadamente no rio o começa a nadar para uma margem no percurso você é sugado\n"
                + "por um Rebojo (Redemoinho na água), que te leva para o fundo do rio e sem forças você acaba...\n");
                        message = "\nMorrendo afogado!\n";
                        delay(message);
    }
    ...
    public static void Pergunta2_3_3_2_2() {
        ...
        System.out.println("Você toma coragem e vai enfrentar as corredeiras, mas quando passa por uma delas você percebe\n"
                ...
                + "pela força da água e não consegue ir para a margem e acaba...\n");
                try{                 
                    TimeUnit.SECONDS.sleep(22);                 
                }                
                catch(InterruptedException e){                                      
                }
                String message = "Morrendo afogado!\n";
                delay(message);
    }
    ...
    public static void Pergunta3_2_2_3_1() {
        ...
        String message = "\n25/03/2020 13:49:57\n";
                ...
                System.out.println("Ao subir na arvore você tenta contato com a central e depois de alguns segundos alguém te responde, você explic\n"
                + "sua situação e eles vão te passar instruções, mas o galho que você está apoiado acaba se arrebentado e cai de uma altura\n"
                + "de 16 metros.\n");
                try{                 
                    TimeUnit.SECONDS.sleep(20);                 
                }                
                ...
                message = "Você morreu após uma queda, ocasionando um traumatismo craniano\n";
                delay(message);
    ...
    public static void Pergunta3_3_3_2_2() {
        ...
        String message = "\n25/03/2020 15:19:23\n";
                delay(message);
                System.out.println("Pelo fato de estar receoso de subir na arvore você começa a tentar fazer contato ali do chão mesmo, depois de alguns\n"
                ...
                System.out.println("\nNisso você acaba caindo em um buraco que estava coberto com folhas e galhos, mas no meio da queda você se sente mais leve e\n"
    ...
    public static void Pergunta3_3_4() {
        ...
        String message = "\n25/03/2020 15:21:18\n";
                ...
                System.out.println("pergunta ao assistente onde você está, então ele fala que vocês estão no avião há caminho da conferência, muito confuso você pergunta se avião\n"
                ...
                + "chega a conclusão que...\n");
                 try{                 
                    TimeUnit.SECONDS.sleep(22);                 
                }                
                catch(InterruptedException e){                                      
                }
                message = "Tudo aquilo foi um sono e nada era real"
                + "\nVocê ganhou!\n)";
                delay(message);
    ...
    public static void Pergunta3_4_3() {
        ...
        String message = "\n25/03/2020 15:20:12\n";
        delay(message);
                System.out.println("Ao investigar ao redor você percebe que se sentindo mais leve lá e que consegue pular muito mais alto, e as plantas são\n"
                ...
                System.out.println("estava saindo do seu corpo e que cada parte que ele passava ficava gelada, ao olhar para suas mãos você não percebe nada de diferente,\n"
                ...
                System.out.println("começa a raciocinar e percebe que o Lockdown está te afetando e as noticias da televisão mais inda.\n");
                message = "\nVocê ganhou!\n";
                delay(message);
    }
